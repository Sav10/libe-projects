...
function set_tip_direction(d_id){


let those_bounds = d3.select("[data-id='" + d_id +"']").node().getBoundingClientRect()

if (those_bounds.x <= 120){

  return 'e'
}

else if ($(window).width() < 600 & those_bounds.x >= 250){
