...
function makesmall_barchart(data_) {
 ...
 //    g.select("g.axis.axis--x")
    ...
    .attr("y", 45)
    .attr('fill', "black")
    .text(function(d) { return String((work_age + this_retraite_sel.duree_cotis_nouveau)).replace('.', ',')})
    .attr('font-size', '11px')
    .attr('class', 'age_retraite_num')
    ...
    .attr("y", 27)
    .attr('fill', "red")
    .text(function(d) { return '+' + String(this_retraite_sel.surplus_duree).replace('.', ',')})
    .attr('font-size', '8px')
    .attr('class', 'age_retraite_num')
