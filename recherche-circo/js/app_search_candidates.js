    ...
    input: {
      selection: (event) => {
        ...
        function show_circ(data){
          ...
          console.log(data_candidats)
          console.log(this_circo)
          console.log(this_circo.substring(0,3), this_circo.substring(4,5))

        

          let this_circo_candidates = `0${this_circo.substring(0,2)}-${this_circo.substring(3,5)}`

          console.log(this_circo_candidates)

          let this_data_candidates = _.cloneDeep(data_candidats).filter(d=>d.circonscription == this_circo_candidates)

          console.log(this_data_candidates)
          ...
          d3.select('#candidats').style('display', 'block')
...
function ready(sortants, T1_Presidentielle, elu_2017, T1_2017, candidates_2022) {
...
console.log(candidates_2022)

data_candidats = candidates_2022
