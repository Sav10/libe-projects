...
let selected_circo = queryString.replace('?id=', '')

let this_dep = selected_circo.substring(0,2)



        function show_circ(circo){

          let this_circo = circo
