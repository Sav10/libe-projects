...
//// Ready function (to load data)
  ...
  function ready(circos_data_T1, circos_data_leg_unflat, circos_data_leg_unflat_T2) {
...
circos_data_leg_unflat_T2.forEach(d=>{
  for (i in vote_variables){
    d[vote_variables[i]] = +d[vote_variables[i]]
  }
  d['votes'] = eval(d['votes'])
...
data_tours['tour1']['data'] = circos_data_unflat;

data_tours['tour2']['data'] = circos_data_leg_unflat_T2;


loadMapFromSvgGeneric(data_tours[tour]['data'], svg_container, circle_range, location_variable, location_prefix, location_type)
