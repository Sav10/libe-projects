...
//     <li style="color:${colorPositivity(this_d.taux_de_positivite)}"><span class='list_element'>Taux de positivité : <span style="font-weight:bold">${String(this_d.taux_de_positivite).replace('.',',')}%</span></span></li>
//     <li style="color:${colorIncidence(this_d.taux_incidence)}"><span class='list_element'> Taux d'incidence : <span style="font-weight:bold">${String(this_d.taux_incidence).replace('.',',')}</span></span></li>
//     <li style="color:${colorR(this_d.tauxReproductionEffectif)}"><span class='list_element'> Taux de reproduction effectif : <span style="font-weight:bold">${String(this_d.tauxReproductionEffectif).replace('.',',')}</span></span></li>
//     <li style="color:${colorOccupation(this_d.tauxOccupationRea)}"><span class='list_element'> Taux d'occupation en réanimation : <span style="font-weight:bold">${String(this_d.tauxOccupationRea).replace('.',',')}%</span></span></li>
//     </ul></span>`
//   })
