...
markerGroup,
chart_made = 0,
data_loaded = {y2017:0, y2012:0, y2017T2:1, y2019:0, y2021:0},
...
/*colorNames['y2019']  = {
  ...
  "POUR L'EUROPE DES GENS": "#af0e1d",
  "LES EUROPÉENS": "#08b2e4",
  "PARTI ANIMALISTE": "#ccc",
...
colorNames['y2019']  = 
{'Liste du Rassemblement National': '#14152d',
 'Liste écologiste': '#42b38e',
 "Liste d'union à gauche": '#eb6184',
 "Liste d'union à droite": '#38529c',
 "Liste d'union au centre": '#ec9528',
 "Liste d'extrême-gauche": '#761519',
 "Liste d'union à gauche avec des écologiste": '#BD6277',
 'Liste divers gauche': '#eb6184',
 "Liste d'union au centre et à droite": '#7993ca',
 'Liste des Républicains': '#35559e',
 'Liste divers centre': '#e77928',
 'Liste régionaliste': '#cfb096',
 'Liste divers droite': '#3d6ab0'}
...
candidats_panneaux['y2019'] = {
    '1': {'score': 0,  'name': 'Liste du Rassemblement National',  'parti': 'Liste du Rassemblement National'},
 '2': {'score': 0, 'name': 'Liste écologiste', 'parti': 'Liste écologiste'},
 '3': {'score': 0,  'name': "Liste d'union à gauche",  'parti': "Liste d'union à gauche"},
 '4': {'score': 0,  'name': "Liste d'union à droite",  'parti': "Liste d'union à droite"},
 '5': {'score': 0,  'name': "Liste d'union au centre",  'parti': "Liste d'union au centre"},
 '6': {'score': 0,  'name': "Liste d'extrême-gauche",  'parti': "Liste d'extrême-gauche"},
 '8': {'score': 0,  'name': "Liste d'union à gauche avec des écologiste",  'parti': "Liste d'union à gauche avec des écologiste"},
 '9': {'score': 0,  'name': 'Liste divers gauche',  'parti': 'Liste divers gauche'},
 '10': {'score': 0,  'name': "Liste d'union au centre et à droite",  'parti': "Liste d'union au centre et à droite"},
 '12': {'score': 0,  'name': 'Liste des Républicains',  'parti': 'Liste des Républicains'},
 '14': {'score': 0,  'name': 'Liste divers centre',  'parti': 'Liste divers centre'},
 '15': {'score': 0,  'name': 'Liste régionaliste',  'parti': 'Liste régionaliste'},
 '17': {'score': 0,  'name': 'Liste divers droite',  'parti': 'Liste divers droite'}}
...
d3.queue()
    ...
    .defer(d3.json, 'https://raw.githubusercontent.com/libe-sixplus/data-election-presidentielle-2017/master/departements.geojson')
    .await(LoadData);
...
if (parseInt(d3.select("#slide-out").style('left')) < 0) 
{
d3.select("#slide-out .ps-scrollbar-y-rail").style('pointer-events', 'none')
