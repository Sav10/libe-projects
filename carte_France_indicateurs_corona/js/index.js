...
function shareTwitter () {
          var url = encodeURIComponent(window.location.origin + window.location.pathname),
              text = "Comment le confinement a gagné toute la planète https://www.liberation.fr/apps/2020/04/comment-le-confinement-a-gagne-la-planete/ via @libe",
