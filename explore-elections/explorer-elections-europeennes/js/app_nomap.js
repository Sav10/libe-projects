...
colorNames['y2019']  = {
  "Rassemblement National":"#2e2b5a",
  "Majorité présidentielle":"#ffb400",
  "Europe Ecologie":"#52ae56",
  "Les Républicains":"#0058a2",
  "La France Insoumise":"#e10f21",
  "PS - Place Publique":"#d82c5d",
  "Debout la France":"#75398a",
  "Générations":"#d82c5d",
  "Parti Communiste": "#af0e1d",
  "UDI": "#08b2e4",
  "Parti animaliste": "#ccc",
  "Urgence Ecologie": "#52ae56",
  "UPR": "#75398a",
};


candidats_panneaux['y2019'] = {
  "23":{"score": 0, "name": "Rassemblement National", "parti": "PRENEZ LE POUVOIR"},
  "5":{"score": 0, "name": "Majorité présidentielle", "parti": "RENAISSANCE"},
  "30":{"score": 0, "name": "Europe Ecologie", "parti": "EUROPE ÉCOLOGIE"},
  "29":{"score": 0, "name": "Les Républicains", "parti": "UNION DE LA DROITE ET DU CENTRE"},
  "1":{"score": 0, "name": "La France Insoumise", "parti": "LA FRANCE INSOUMISE"},
  "12":{"score": 0, "name": "PS - Place Publique", "parti": "ENVIE D'EUROPE"},
  "15":{"score": 0, "name": "Debout la France", "parti": "LE COURAGE DE DÉFENDRE LES FRANÇAIS"},
  "21":{"score": 0, "name": "Générations", "parti": "LISTE CITOYENNE DU PRINTEMPS EUROPÉEN"},
  "19":{"score": 0, "name": "Parti Communiste", "parti": "POUR L'EUROPE DES GENS"},
  "11":{"score": 0, "name": "UDI", "parti": "LES EUROPÉENS"},
  "31":{"score": 0, "name": "Parti animaliste", "parti": "PARTI ANIMALISTE"},
  "9":{"score": 0, "name": "Urgence Ecologie", "parti": "URGENCE ÉCOLOGIE"},
  "20":{"score": 0, "name": "UPR", "parti": "ENSEMBLE POUR LE FREXIT"}
}
...
setTimeout(function () {
    ...
    function shareTwitter () {
      var url = encodeURIComponent(window.location.origin + window.location.pathname)
      var text = "Explorer les votes aux européennes par rapport aux dernières présidentielles. Visualisez les résultats des élections en fonction de critères socio démographiques (CSP, démographie...) https://www.liberation.fr/apps/2019/05/explorer-elections-europeennes/ via @libe"
