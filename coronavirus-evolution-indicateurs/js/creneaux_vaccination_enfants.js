...
else if(x <=500){ return '#E3234A'}
else if(x <=1000){ return '#6d142d'}
else { return '#000'}
}
...
queue()
  ...
  .defer(d3.csv, 'data/creneaux_vax_kids.csv')
  .await(ready)
...
/*      d.tx_positivite = +d.tx_positivite*/
      d.creneaux = +d.creneaux;
      d.population = +d.population;
      d.pour1000hab = +d.pour1000hab;
